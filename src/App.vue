                        ...
                        <div id="middle-content">
                            <div id="learning-materials" class="rounded shadow">
                                ...
                                <a href="https://nxplaybook.com/?utm_source=nx-project" target="_blank" rel="noreferrer" class="list-item-link">
                                    ...
                                    <span>
                                        Video courses<span>Nx custom courses </span>
                                    </span>
                                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                    </svg>
                            ...
                            <div id="other-links">
                                <a id="nx-console" class="button-pill rounded shadow" href="https://marketplace.visualstudio.com/items?itemName=nrwl.angular-console&amp;utm_source=nx-project" target="_blank" rel="noreferrer">
                                    ...
                                    <span>
                                        Install Nx Console<span>Plugin for VSCode</span>
                                    </span>
                                </a>
                                <div id="nx-cloud" class="rounded shadow">
                                    <div>
                                        <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M120 15V30C103.44 30 90 43.44 90 60C90 76.56 76.56 90 60 90C43.44 90 30 103.44 30 120H15C6.72 120 0 113.28 0 105V15C0 6.72 6.72 0 15 0H105C113.28 0 120 6.72 120 15Z" fill="#0E2039"></path>
                                            <path d="M120 30V105C120 113.28 113.28 120 105 120H30C30 103.44 43.44 90 60 90C76.56 90 90 76.56 90 60C90 43.44 103.44 30 120 30Z" fill="white"></path>
                                        </svg>
                                        <h2>
                        ...
                        <div id="commands" class="rounded shadow">
                            ...
                            <details>
                                ...
                                <pre>
                                    ...
                                    nx g @nrwl/next:library ui<span># Add a component</span>
                            ...
                            <details>
                                ...
                                <pre>
                                    ...
                                    nx affected:graph<span># run tests for current changes</span>
                                    nx affected:test<span># run e2e tests for current changes</span>
                                    nx affected:e2e
                                </pre>
                            </details>
                        </div>
